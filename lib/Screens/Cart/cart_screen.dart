...
class CartProducts extends StatelessWidget {
  const CartProducts({super.key, required this.cartModel});
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () {
        MainCubit.get(context)
            .getProductData(cartModel.product!.id)
            .then((value) => navigateTo(context, ProductDetailsScreen()));
      },
      child: Card(
        margin: const EdgeInsets.all(8).r,
                    ...
                    Row(
                      children: [
                        SizedBox(
                          ...
                          child: MaterialButton(
                            onPressed: () {
                              ...
                              if (quantity != 0) {
                                MainCubit.get(context)
                                    .updateCartData(cartModel.id!, quantity);
                              }
                            },
                            minWidth: 10.w,
                            height: 10.h,
                        ...
                        TextButton(
                          onPressed: () {
                            MainCubit.get(context)
                                .changeFavorites(cartModel.product!.id!);
                          },
                          child: Row(
                            children: [
                              Icon(
                                MainCubit.get(context)
                                        .favorites[cartModel.product!.id]
                                    ? Icons.favorite
                                    : Icons.favorite_border,
                                color: MainCubit.get(context)
                                        .favorites[cartModel.product!.id]
                        ...
                        TextButton(
                          onPressed: () {
                            MainCubit.get(context)
                                .changeCart(cartModel.product!.id!);
                          },
                          child: Row(
                            children: [
                              Icon(
